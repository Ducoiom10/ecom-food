    ...
    <div id="main-content" class="hidden p-4 lg:p-8 max-w-7xl mx-auto pb-32 lg:pb-8">
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-10 lg:items-start">
            ...
            <div class="lg:sticky lg:top-24">
                ...
                <div class="hidden lg:grid grid-cols-3 gap-3 mt-4">
                    <div class="bg-white border-2 border-[#1C1C1C] rounded-xl p-3 text-center shadow-[2px_2px_0px_#1C1C1C]">
                        ...
                        <div class="font-black text-[#1C1C1C] text-sm"><?php echo e($product->category?->name); ?></div>
                        <div class="text-xs text-gray-400">Danh mục</div>
                    </div>
                    <div class="bg-white border-2 border-[#1C1C1C] rounded-xl p-3 text-center shadow-[2px_2px_0px_#1C1C1C]">
                        <div class="text-xl mb-1">🔥</div>
                        <div class="font-black text-[#1C1C1C] text-sm"><?php echo e($product->calories ?? '—'); ?> kcal</div>
            ...
            <div class="mt-4 lg:mt-0 space-y-5">
                ...
                <div>
                    <h1 class="font-black text-[#1C1C1C] text-2xl lg:text-3xl leading-tight"><?php echo e($product->name); ?></h1>
                    <p class="text-gray-600 text-sm lg:text-base mt-3 leading-relaxed"><?php echo e($product->description); ?></p>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <div class="font-black text-[#FF6B35] text-2xl lg:text-3xl">
                            <?php echo e(number_format($product->base_price)); ?>đ</div>
                    </div>
                    ...
                    <details class="bg-green-50 border-2 border-green-200 rounded-xl overflow-hidden group">
                        ...
                        <div class="px-4 pb-4 space-y-2">
                            <div class="flex justify-between text-sm py-1.5 border-b border-green-100">
                                ...
                                <span class="font-bold text-[#1C1C1C]"><?php echo e($product->calories); ?> kcal</span>
                            </div>
                        </div>
                    </details>
                <?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if($isRequired): ?>
                                <div class="flex gap-2 flex-wrap">
                                    <?php $__currentLoopData = $option->values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="flex-1 cursor-pointer min-w-[80px]">
                                            <input type="radio" name="option_<?php echo e($option->id); ?>"
                                                value="<?php echo e($val->id); ?>" class="hidden peer"
                                                <?php echo e($loop->first ? 'checked' : ''); ?> onchange="updateOptionPrice()" />
                                            <div
                                                ...
                                                <div><?php echo e($val->label); ?></div>
                                                <?php if($val->extra_price > 0): ?>
                                                    <div class="text-xs opacity-80">
                                                        +<?php echo e(number_format($val->extra_price)); ?>đ</div>
                                                <?php else: ?>
                                        ...
                                        <label
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div
                                                    ...
                                                    <input type="checkbox" name="toppings[]" value="<?php echo e($val->id); ?>"
                                                ...
                                                <span class="font-bold text-sm text-[#1C1C1C]"><?php echo e($val->label); ?></span>
                                            </div>
                                            <span
                                                class="text-[#FF6B35] font-black text-sm">+<?php echo e(number_format($val->extra_price)); ?>đ</span>
                                        </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
                ...
                <?php if($related && $related->count() > 0): ?>
                                ...
                                <a href="#"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="font-bold text-xs text-[#1C1C1C] line-clamp-2 leading-tight">
                                            <?php echo e($rel->name); ?></div>
                                        <div class="font-black text-[#FF6B35] text-sm mt-1">
                                            <?php echo e(number_format($rel->base_price)); ?>đ</div>
                                    </div>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        const optionValues = <?php echo json_encode(
            $product->options
        ...
        function addToCartPDP(isBuyNow = false) {
            ...
            fetch('<?php echo e(route('client.cart.add')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ecom-food\resources\views/client/products/detail.blade.php ENDPATH**/ ?>