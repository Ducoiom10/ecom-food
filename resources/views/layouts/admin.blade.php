                    ...
                    @if (auth()->user()->hasPermission($item['perm']))
                        ...
                        <a href="{{ route($item['route']) }}"
                            class="nav-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all
                                  {{ $isActive ? $item['color'] . ' text-white shadow-lg' : 'text-gray-400 hover:bg-[#252525] hover:text-white' }}">
                    ...
                    <div class="relative" id="user-menu-container">
                        ...
                        <div id="user-dropdown"
                            ...
                            <div class="px-3 py-2 border-b border-[#333]">
                                ...
                                <p class="text-[10px] text-gray-400 uppercase">{{ auth()->user()->role }}</p>
                            </div>
