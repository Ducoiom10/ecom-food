...
<div class="min-h-screen flex">
  ...
  <aside id="sidebar"
    ...
    <nav class="flex-1 p-2 space-y-1 overflow-y-auto">
      @php
        $navItems = [
          ['route'=>'admin.kds',       'icon'=>'👨🍳', 'label'=>'Bếp KDS',     'color'=>'bg-orange-500'],
          ['route'=>'admin.smartprep', 'icon'=>'🧠',   'label'=>'Smart Prep',  'color'=>'bg-purple-500'],
          ['route'=>'admin.dispatch',  'icon'=>'🚚',   'label'=>'Điều phối',   'color'=>'bg-blue-500'],
          ['route'=>'admin.branch',    'icon'=>'🍴',   'label'=>'Chi nhánh',   'color'=>'bg-green-500'],
          ['route'=>'admin.super',     'icon'=>'📊',   'label'=>'Super Admin', 'color'=>'bg-red-500'],
        ];
      @endphp
